...
public class AddComment extends Activity implements OnClickListener{
    ...
    private static final String POST_COMMENT_URL = "http://192.168.1.7/webservice/addcomment.php";
    
    //testing on Emulator:
    //private static final String POST_COMMENT_URL = "http://10.0.2.2:1234/webservice/addcomment.php";
    
  //testing from a real server:
    //private static final String POST_COMMENT_URL = "http://www.theartistandtheengineer.co/webservice/addcomment.php";
